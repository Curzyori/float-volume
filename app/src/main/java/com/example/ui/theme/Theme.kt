...
private val DarkColorScheme =
  darkColorScheme(
    ...
    secondaryContainer = ElegantDarkSurface,
    ...
    onSurfaceVariant = ElegantDarkMutedText,
    outline = ElegantDarkDivider,
    outlineVariant = ElegantDarkDivider
  )
...
fun MyApplicationTheme(
  ...
  // Dynamic color is disabled by default for Elegant Dark custom colors
